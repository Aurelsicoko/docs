...
The **Edit online** feature lets you update your site’s code directly in Fimo’s built-in editor.  
No setup required — everything happens in your browser.
...
Behind the scenes, Fimo groups your edits into a single commit after **1 minute of inactivity**, so your history stays clean and easy to follow.
