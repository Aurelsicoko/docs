...
A **project** in Fimo represents a single website. Each project has its **own database**, **content**, **assets**, **code**, and **settings**. Projects are fully independent, so changes in one never affect another.
...
<Columns cols={2}>
  <Card title="Preview window" icon="eye">
    Test and collaborate safely before publishing.
  </Card>
  <Card title="Content" icon="pen-to-square">
