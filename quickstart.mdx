...
<AccordionGroup>
  ...
  <Accordion icon="keyboard" title="Write your first prompt">
    ...
    **Example prompt:** *“Create a website that lists non-profit organizations in Spain.”*  
...
<AccordionGroup>
  ...
  <Accordion icon="brush" title="Update your site name and colors">
    1. At the top of the editor, click the **Project name dropdown**.  
    2. Select **Project Settings**.  
    3. Update your **site name, colors, and branding** from there.  
  </Accordion>
</AccordionGroup>
