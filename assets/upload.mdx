...
<Note>
There’s no practical limit on the total number of files you can store. Each project comes with its own dedicated media library.  
However, Fimo actively monitors usage and may reach out to projects that abuse the system under our **Fair Use Policy**.
</Note>