...
- <Icon icon="bolt"/> **Builds and deploys** the current **Preview** state  
- <Icon icon="shield"/> **Creates a read-only snapshot** for Production  
- <Icon icon="arrows-rotate"/> **Updates all pages and assets** in one go
