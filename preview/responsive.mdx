...
**Responsive mode** lets you test how your site looks on different devices and screen sizes.  
Switch between desktop, tablet, and mobile, adjust zoom, and rotate devices horizontally or vertically.
...
<Columns cols={2}>
  <Card title="Test layouts" icon="columns">
