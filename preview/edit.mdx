...
Click any element to change its text, image, or style.  
All edits are saved in the built-in CMS and Media Library, and you can manage them later in [Content](/content/introduction) or [Assets](/assets/introduction).
...
<Tip>
You can ask AI to restyle components (for example, “make this card more compact with tighter spacing and a subtle border”).  
Edit mode lets you fine-tune the details visually.
</Tip>

<Note>
All changes made in Edit mode affect Preview only.  
Your live site updates when you publish.
</Note>
