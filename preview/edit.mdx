...
Click any element to change its text, image, or style. All edits are saved in the built-in CMS, and you can manage them later in **Content**.
...
<Columns cols={2}>
  ...
  <Card title="Saved to CMS" icon="database">
    Your edits are stored automatically and available in the Content section.
  </Card>
...
<Tip>
Prefer prompts? Ask AI to rewrite, shorten, translate, or adjust tone. You can refine manually afterward in Edit mode.
</Tip>
...
<Note>
Image sources and alt text are stored in the CMS so you can reuse assets across pages.
</Note>
